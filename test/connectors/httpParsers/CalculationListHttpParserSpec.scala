...
import assets.CalculationListDesTestConstants.{badRequestSingleError, calculationListFull, calculationListMin, jsonResponseFull, jsonResponseMin, jsonSingleError}
