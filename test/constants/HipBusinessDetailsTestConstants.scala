...
import constants.HipAddressDetailsTestConstants._
import constants.HipCessationTestConstants._
import constants.HipContactDetailsTestConstants._
import models.hip.incomeSourceDetails.{BusinessDetailsModel, LatencyDetails, QuarterTypeElection}
import play.api.libs.json.{JsObject, Json}

import java.time.LocalDate

object HipBusinessDetailsTestConstants {
  ...
  val testBusinessDetailsModelJson = Json.parse(
    """
      |{
      |  "incomeSourceId" : "111111111111111",
