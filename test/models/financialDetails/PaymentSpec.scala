...
class PaymentSpec extends AnyWordSpec with Matchers {
  ...
  val paymentEmpty: Payment = Payment(None, 1000.00, None, None, None, None, None, None, LocalDate.parse("2022-06-23"), "DOCID01", None, None)

  val paymentEmptyJson: JsObject = Json.obj("amount" -> 1000, "documentDate" -> LocalDate.parse("2022-06-23"), "transactionId" -> "DOCID01")
