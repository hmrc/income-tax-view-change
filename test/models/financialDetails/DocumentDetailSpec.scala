...
class DocumentDetailSpec extends WordSpec with Matchers {
  ...
  val documentDetailMin: DocumentDetail = DocumentDetail("2019", "id", None, None, None)

  val documentDetailMinJsonRead: JsObject = Json.obj("taxYear" -> "2019", "documentId" -> "id")
  val documentDetailMinJsonWrite: JsObject = Json.obj("taxYear" -> "2019", "transactionId" -> "id")
