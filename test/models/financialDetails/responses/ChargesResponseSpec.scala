      ...
      "return payments" when {
        ...
        "a single payment exists" in {
          ChargesResponse(
            ...
            Payment(Some("ref"), Some(-1000.0), Some(700), None, Some("method"), None, None, Some(LocalDate.parse("2022-06-23")), "DOCID01")
          )
        }
        ...
        "multiple payments exist" in {
          ChargesResponse(
            ...
            Payment(Some("ref"), Some(-1000.0), Some(700), None, Some("method"), None, None, Some(LocalDate.parse("2022-06-23")), "DOCID01"),
            Payment(Some("ref"), Some(-1000.0), Some(700), None, Some("method"), None, None, Some(LocalDate.parse("2022-06-23")), "DOCID02")
          )
        }
      }
    }
