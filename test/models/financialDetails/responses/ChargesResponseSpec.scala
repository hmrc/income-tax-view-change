      ...
      "return payments" when {
        ...
        "a single payment exists" in {
          ChargesResponse(
            ...
            Payment(Some("ref"), Some(-1000.0), Some(700), None, Some("method"), None, None, Some("dueDate"), "DOCID01")
          )
        }
        ...
        "multiple payments exist" in {
          ChargesResponse(
            ...
            Payment(Some("ref"), Some(-1000.0), Some(700), None, Some("method"), None, None, Some("dueDate"), "DOCID01"),
            Payment(Some("ref"), Some(-1000.0), Some(700), None, Some("method"), None, None, Some("dueDate"), "DOCID02")
          )
        }
      }
    }
